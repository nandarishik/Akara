...
SUPABASE_CLIENT_PATHS = [
    ...
    "app.api.v1.auth.get_supabase_service_client",
    "app.api.v1.system.get_supabase_service_client",
    "app.api.superadmin.tenants.get_supabase_service_client",
    "app.api.superadmin.quota.get_supabase_service_client",
    "app.api.superadmin.plan.get_supabase_service_client",
    "app.api.superadmin.users.get_supabase_service_client",
    "app.api.superadmin.data.get_supabase_service_client",
    "app.api.superadmin.conversations.get_supabase_service_client",
    "app.api.superadmin.billing.get_supabase_service_client",
    "app.api.superadmin.reports.get_supabase_service_client",
    "app.api.superadmin.security.get_supabase_service_client",
    "app.api.superadmin.impersonate.get_supabase_service_client",
    "app.api.superadmin.audit.get_supabase_service_client",
