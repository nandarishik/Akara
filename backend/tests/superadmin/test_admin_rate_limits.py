...
def test_admin_billing_read_rate_limit(
    mock_sa_supa, mock_billing_supa, superadmin_client
):
    ...
    billing_supa.table.return_value.select.return_value.gte.return_value.order.return_value.limit.return_value = events_mock
