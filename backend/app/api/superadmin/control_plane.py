...
RUNBOOKS: dict[str, dict[str, Any]] = {
    ...
    "revoke_all_tenant_sessions": {"purpose": "Revoke every active session for a tenant", "parameters": {"tenant_id": "uuid"}, "max_rows": 100_000, "rollback": "not_reversible: sessions cannot be restored", "reversible": False, "permission": "runbooks:sessions", "dry_run_required_before_real": True},
