...
// Temporarily disabled due to missing @marsidev/react-turnstile package
...
//   // Dynamic import keeps Turnstile out of the main bundle for pages that don't need it
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full border rounded-lg px-3 py-2.5 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 ${
              ...
              {passwordError && (
                <p id="pw-error" className="text-xs text-red-600 mt-1" role="alert">{passwordError}</p>
              )}
            </div>
            ...
            <div>
              ...
              <div className="flex">
                <span className="inline-flex items-center px-3 border border-r-0 border-slate-300 rounded-l-lg bg-slate-50 text-slate-600 text-sm">
                  🇮🇳 +91
                </span>
                <input
                  id="whatsapp"
                  ...
                  className="flex-1 border border-slate-300 rounded-r-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
                />
              </div>
            ...
            <div className="space-y-3 pt-2">
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <span className="text-sm text-slate-700">
                  I agree to the{" "}
                  <Link to="/terms" className="text-blue-600 underline" target="_blank">Terms of Service</Link>
                  {" "}and{" "}
                  <Link to="/privacy" className="text-blue-600 underline" target="_blank">Privacy Policy</Link>
                </span>
              </label>
            ...
            <button
              type="submit"
              disabled={!canSubmit}
              className="w-full bg-[#1565C0] hover:bg-[#1976D2] disabled:bg-slate-200 disabled:text-slate-400 text-white py-3 rounded-lg font-semibold transition-colors mt-2"
            >
              {loading ? (
